...
import { byMaxRarityDesc, defaultCrewComparator, byRarityDesc } from '../crew/sorters';
...
function DuplicatesPage() {
  ...
  const groups = data
    ? [...getDuplicateCrewGroups(getCrewList(data), frozenArchetypeIds)].sort((a, b) =>
        combineComparators(byMaxRarityDesc, defaultCrewComparator(collections), byRarityDesc)(a.crew, b.crew)
      )
    : [];
